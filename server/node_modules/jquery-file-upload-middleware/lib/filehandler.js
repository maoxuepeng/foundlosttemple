    ...
    return function (req, res, next) {
        ...
        var handler = new UploadHandler(req, res, function (result, redirect) {
            if (redirect) {
                ...
                var result_new = {files: result};
                redirect = redirect.replace('albums/edit', 'jQuery-File-Upload-master');
                console.log('redirect = ' + redirect);
                res.redirect(redirect.replace(/%s/, encodeURIComponent(JSON.stringify(result_new))));
            } else {
                res.set({
